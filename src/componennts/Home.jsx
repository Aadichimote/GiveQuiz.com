...
const Home=  () => {
  ...
  return (
    <section className="lg:w-9/12 md:w-[90%] px-4 mx-auto mt-12 flex flex-col md:flex-row-reverse justify-between items-center">
      ...
      <div className="md:1/2 w-full space-y-5 ">
        ...
        <div className="text-lg flex flex-col sm:flex-row gap-5 mb-5">
          ...
          <button className=" px-6  py-2 text-yellow-500 ml-3 hover:bg-yellow-500 hover:text-white transition-all duration-300 ease-in">
            {" "}
            >learn more
          </button>
        </div>
